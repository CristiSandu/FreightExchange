...
{
    public class ContractTransporterPageViewModel : BaseViewModel
    {
        ...
        public ContractTransporterPageViewModel()
        {
            GetData();
            RefreshCommand = new Command(async () =>
            {
                ...
                List<Models.ContractModel> contracts = await Services.FirestoreServiceProvider.GetFirestoreContractsForAClient(userId, "transporter_id");
